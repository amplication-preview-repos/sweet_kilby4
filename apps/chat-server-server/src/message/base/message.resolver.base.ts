...
import { PrivateChat } from "../../privateChat/base/PrivateChat";
...
export class MessageResolverBase {
  ...
  async createMessage(
    ...
    return await this.service.createMessage({
      ...
      data: {
        ...
        groupChat: args.data.groupChat
          ? {
              connect: args.data.groupChat,
            }
          : undefined,

        privateChat: args.data.privateChat
          ? {
              connect: args.data.privateChat,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => GroupChat, {
    nullable: true,
    name: "groupChat",
  })
  async getGroupChat(
    ...
    const result = await this.service.getGroupChat(parent.id);
  ...
  @graphql.ResolveField(() => PrivateChat, {
    nullable: true,
    name: "privateChat",
  })
  async getPrivateChat(
    ...
    const result = await this.service.getPrivateChat(parent.id);
